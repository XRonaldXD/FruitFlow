    ...
    <div class="container mt-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="../ReserveFruitsHandler?action=reserveFruit_warehouse" class="btn btn-secondary">Reserve Fruits</a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item">Reservation #123 needs approval.</li>
                    <li class="list-group-item">Borrow request #456 pending.</li>
                    <li class="list-group-item">Delivery #789 is in transit.</li>
                </ul>
            </div>
        </div>
    </div>
