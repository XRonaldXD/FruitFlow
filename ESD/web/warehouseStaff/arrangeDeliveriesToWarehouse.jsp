<%-- 
    Document   : arrangeDeliveriesToWarehouse
    Created on : 2025年4月23日, 下午6:14:34
    Author     : user
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-4">
            <h1 class="mb-4">Arrange Delivery to Warehouse</h1>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= reservation.getWarehouseName()%></td>
                        ...
                        <td>
                            <form action="DeliveriesHandler" method="POST">
                                ...
                                <input type="hidden" name="toWarehouseId" value="<%= reservation.getWarehouseId()%>">
                                ...
                                <button type="submit" name="action" value="arrange" class="btn btn-primary mt-2">Arrange Delivery</button>
                            </form>
                        </td>
                    </tr>
                    <%
